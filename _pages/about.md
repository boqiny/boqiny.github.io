...
- **ML systems and inference** - serving models under production load with SGLang, vLLM, speculative decoding, quantization, Kubernetes, and AWS. Built [speculative tool calling](https://github.com/boqiny/spec_tool_call){:.hl} to cut agent latency.
